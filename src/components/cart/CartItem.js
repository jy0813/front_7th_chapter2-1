export const CartItem = (item, isChecked = false) => {
  const { id, image, title, price, quantity, totalPrice } = item;
  ...
  return /* HTML */ `
    ...
    >
      ...
      <!-- 상품 이미지 -->
      <div
        class="w-16 h-16 bg-gray-100 rounded-lg overflow-hidden mr-3 flex-shrink-0"
      >
        <img
          src="${image}"
          alt="${title}"
